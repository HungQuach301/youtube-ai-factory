...
type Snapshot = {
  ...
  batchActivationControl: { preflight: null | { id: string; status: string; inputHash: string; result: { nextIndex?: number; total?: number; products?: number; frames?: number; grammars?: number; families?: number; maximumFamilyShare?: number; requestsDelta?: number; costDelta?: number }; requestsBefore: number; costBefore: number; updatedAt: string }; activation: null | { id: string; status: string; idempotencyKey: string; targetBatchId: string; inputHash: string; result: Record<string, unknown>; committedAt: string | null } };

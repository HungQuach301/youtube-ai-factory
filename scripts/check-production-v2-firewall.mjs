...
const roots = ["app/video-engine", "app/api/factory/production-v2", "lib/production-v2-projection.ts", "lib/production-v2-command.ts", "lib/production-v2-scale.ts", "app/production-v2-contract.ts"];

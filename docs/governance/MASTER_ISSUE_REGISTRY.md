...
| X36 | P1 | Git truth can diverge between ChatGPT Sites and the user's personal GitHub | `ACTIVE_CONTROL__GITHUB_REMOTE_PENDING`: one-commit dual-remote policy blocks completion until local main, origin/main and github/main match; divergence cannot be force-resolved automatically | Repository governance |

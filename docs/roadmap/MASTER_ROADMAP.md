...
- Audience Golden Sequence R1–R12 are preserved rejected evidence. Sites v493 sealed R12 exact master `a6f5d16a…`; audio QA passes 94 with no findings, while visual QA fails 87 because the clearing delta lacks an explicit fee equation, obligation markers are too small and the state map repeats too long. Migration `0097` prepares R13 with an always-visible `2,00 + 0,05 = 2,05` equation, large labeled netting groups, four full-frame states and a state-bound exception quartet. Browser/device, owner review and freeze remain blocked until their owning gates open. Document 78 is authoritative; V2 is untouched.

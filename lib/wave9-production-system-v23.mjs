...
export function compileWave9ProductionSystemV23({ shotCount, activeRequests, upstreamFrozen, acceptedBaseline = 36, preProductionCompiled = false, storyboardsRendered = false }) {
  ...
  const status = !inputReady
    ...
    : !ledgerClear
      ...
      : storyboardsRendered
        ? "STORYBOARDS_RENDERED_ANIMATIC_REQUIRED"
        : preProductionCompiled
          ? "PREPRODUCTION_COMPILED_READY_TO_RENDER_STORYBOARDS"

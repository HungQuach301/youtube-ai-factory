...
- Portfolio projection: `NICHE_PORTFOLIO_PROJECTION_V2`, `GET /api/factory/niche-portfolio`, canonical V7 compatibility bridge plus append-only expert hypotheses with truthful assumption/evidence separation.
...
- Next action: Slice 4 bounded research planning, evidence validation and expert evidence review.

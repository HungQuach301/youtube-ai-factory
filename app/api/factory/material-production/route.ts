...
const WAVE_BATCH_2_V19_PROCESS_REVISION = "V19_3_PORT_EGRESS_COMPLETE_LAYOUT_SOLVER";
...
async function snapshot() {
  ...
  const expectedPreflightAction = v15ControlVisible ? "PREFLIGHT_WAVE_BATCH_2_V19_SYSTEMIC_ACTIVATION" : v13ControlVisible ? "PREFLIGHT_WAVE_BATCH_2_V13_ACTIVATION" : v12ControlVisible ? "PREFLIGHT_WAVE_BATCH_2_V12_ACTIVATION" : v11ControlVisible ? "PREFLIGHT_WAVE_BATCH_2_V11_ACTIVATION" : "PREFLIGHT_WAVE_BATCH_2_V10_ACTIVATION";
  const expectedActivationAction = v15ControlVisible ? "ADOPT_WAVE_BATCH_2_V19_SYSTEMIC_PROCESS_CORRECTION" : v13ControlVisible ? "ADOPT_WAVE_BATCH_2_V13_ENGINE_ROOT_CORRECTION" : v12ControlVisible ? "ADOPT_WAVE_BATCH_2_V12_ENGINE_ROOT_CORRECTION" : v11ControlVisible ? "ADOPT_WAVE_BATCH_2_V11_ENGINE_ROOT_CORRECTION" : "ADOPT_WAVE_BATCH_2_V10_ENGINE_ROOT_CORRECTION";
...
const SYSTEMIC_LAYOUT_FAMILIES = ["ROUTE", "SWIMLANE", "SPLIT", "STACK", "RADIAL", "TIMELINE", "MATRIX", "LEDGER", "FIELD", "TABLE"] as const;

function systemicSemanticTopology(corpus: string) {
  if (/PRODUCT/.test(corpus) && /CATEGORY/.test(corpus) && /CHANNEL/.test(corpus) && /DATE/.test(corpus)) return "CONTROL_TABLE";
  if (/FIVE POSITION|FIVE LABELED|CARDHOLDER/.test(corpus) && /MERCHANT/.test(corpus) && /ISSUER/.test(corpus)) return "ROLE_SYSTEM";
  if (/RESPONSE/.test(corpus) && /NETWORK/.test(corpus) && /MERCHANT/.test(corpus)) return "ORDERED_RETURN_ROUTE";
  if (/REQUEST/.test(corpus) && /BOUNDARY|SHUTTER|LANE/.test(corpus)) return "BOUNDARY_TRANSFER";
  if (/LEDGER|TRAY|WORKSPACE/.test(corpus) && /INTERCHANGE|FEE|REVENUE/.test(corpus)) return "VALUE_CONTAINMENT";
  if (/NOT |NO |EMPTY|UNTOUCHED|INACTIVE|CLOSED|ABSENT/.test(corpus)) return "NEGATIVE_CONSTRAINT";
  if (/COMPARE|VERSUS|SEPARATE|DISTINCT/.test(corpus)) return "EVIDENCE_COMPARISON";
  return "SOURCE_TRANSFORM_DESTINATION";
}

function systemicLayoutSlots(family: string, count: number) {
  const layouts: Record<string, Array<{ x: number; y: number; w: number; h: number }>> = {
    ROUTE: [{ x: 54, y: 190, w: 170, h: 116 }, { x: 266, y: 190, w: 170, h: 116 }, { x: 478, y: 190, w: 170, h: 116 }, { x: 690, y: 190, w: 216, h: 116 }, { x: 266, y: 330, w: 170, h: 82 }, { x: 478, y: 330, w: 170, h: 82 }],
    SWIMLANE: [{ x: 74, y: 128, w: 250, h: 78 }, { x: 354, y: 128, w: 250, h: 78 }, { x: 634, y: 128, w: 250, h: 78 }, { x: 74, y: 252, w: 250, h: 78 }, { x: 354, y: 252, w: 250, h: 78 }, { x: 634, y: 252, w: 250, h: 78 }],
    SPLIT: [{ x: 58, y: 132, w: 260, h: 170 }, { x: 350, y: 184, w: 260, h: 96 }, { x: 642, y: 132, w: 260, h: 170 }, { x: 58, y: 326, w: 260, h: 82 }, { x: 350, y: 326, w: 260, h: 82 }, { x: 642, y: 326, w: 260, h: 82 }],
    STACK: [{ x: 94, y: 102, w: 772, h: 68 }, { x: 94, y: 184, w: 772, h: 68 }, { x: 94, y: 266, w: 772, h: 68 }, { x: 94, y: 350, w: 238, h: 68 }, { x: 361, y: 350, w: 238, h: 68 }, { x: 628, y: 350, w: 238, h: 68 }],
    RADIAL: [{ x: 362, y: 104, w: 236, h: 82 }, { x: 72, y: 218, w: 236, h: 82 }, { x: 652, y: 218, w: 236, h: 82 }, { x: 362, y: 334, w: 236, h: 82 }, { x: 72, y: 334, w: 236, h: 82 }, { x: 652, y: 334, w: 236, h: 82 }],
    TIMELINE: [{ x: 56, y: 148, w: 156, h: 104 }, { x: 230, y: 242, w: 156, h: 104 }, { x: 404, y: 148, w: 156, h: 104 }, { x: 578, y: 242, w: 156, h: 104 }, { x: 752, y: 148, w: 156, h: 104 }, { x: 404, y: 340, w: 156, h: 76 }],
    MATRIX: [{ x: 66, y: 116, w: 256, h: 130 }, { x: 352, y: 116, w: 256, h: 130 }, { x: 638, y: 116, w: 256, h: 130 }, { x: 66, y: 276, w: 256, h: 130 }, { x: 352, y: 276, w: 256, h: 130 }, { x: 638, y: 276, w: 256, h: 130 }],
    LEDGER: [{ x: 58, y: 116, w: 384, h: 166 }, { x: 518, y: 116, w: 384, h: 166 }, { x: 58, y: 306, w: 190, h: 84 }, { x: 270, y: 306, w: 190, h: 84 }, { x: 482, y: 306, w: 190, h: 84 }, { x: 694, y: 306, w: 190, h: 84 }],
    FIELD: [{ x: 70, y: 108, w: 820, h: 82 }, { x: 70, y: 210, w: 236, h: 136 }, { x: 362, y: 210, w: 236, h: 136 }, { x: 654, y: 210, w: 236, h: 136 }, { x: 70, y: 360, w: 382, h: 60 }, { x: 508, y: 360, w: 382, h: 60 }],
    TABLE: [{ x: 62, y: 108, w: 260, h: 112 }, { x: 350, y: 108, w: 548, h: 112 }, { x: 62, y: 244, w: 260, h: 112 }, { x: 350, y: 244, w: 260, h: 112 }, { x: 638, y: 244, w: 260, h: 112 }, { x: 62, y: 372, w: 260, h: 60 }],
  };
  return (layouts[family] || layouts.ROUTE).slice(0, Math.max(3, Math.min(6, count)));
}

function systemicMotionPath(objects: Row[], semanticTopology: string, railY: number) {
  const centers = [...new Set(objects.map((item) => {
    const box = rec(item.geometry);
    return Math.round(Number(box.x) + Number(box.w) / 2);
  }).filter((value) => Number.isFinite(value)))].sort((a, b) => a - b);
  const anchors = centers.length >= 3 ? [centers[0], centers[Math.floor((centers.length - 1) / 2)], centers[centers.length - 1]] : [128, 480, 832];
  const distinct = new Set(anchors).size === 3 ? anchors : [128, 480, 832];
  const directed = semanticTopology === "ORDERED_RETURN_ROUTE" ? [...distinct].reverse() : distinct;
  return directed.map((x) => [x, railY]);
}

function systemicRelationshipCorridor(from: Row, to: Row, objects: Row[], relationshipIndex: number) {
  const geometry = (item: Row) => { const box = rec(item.geometry); return { id: clean(item.id), x: Number(box.x), y: Number(box.y), w: Number(box.w), h: Number(box.h) }; }, a = geometry(from), b = geometry(to), allBoxes = objects.map(geometry);
  const intersectsVertical = (x: number, startY: number, endY: number, ownId: string) => allBoxes.some((box) => box.id !== ownId && x > box.x && x < box.x + box.w && Math.max(Math.min(startY, endY), box.y) < Math.min(Math.max(startY, endY), box.y + box.h));
  const intersectsHorizontal = (y: number, startX: number, endX: number, ownId: string) => allBoxes.some((box) => box.id !== ownId && y > box.y && y < box.y + box.h && Math.max(Math.min(startX, endX), box.x) < Math.min(Math.max(startX, endX), box.x + box.w));
  const escapes = (box: { id: string; x: number; y: number; w: number; h: number }) => {
    const cx = box.x + box.w / 2, cy = box.y + box.h / 2;
    return [
      { side: "TOP", port: [cx, box.y], outer: [cx, 86], valid: !intersectsVertical(cx, box.y, 86, box.id) },
      { side: "RIGHT", port: [box.x + box.w, cy], outer: [916, cy], valid: !intersectsHorizontal(cy, box.x + box.w, 916, box.id) },
      { side: "BOTTOM", port: [cx, box.y + box.h], outer: [cx, 438], valid: !intersectsVertical(cx, box.y + box.h, 438, box.id) },
      { side: "LEFT", port: [box.x, cy], outer: [44, cy], valid: !intersectsHorizontal(cy, box.x, 44, box.id) },
    ].filter((candidate) => candidate.valid);
  };
  const perimeter = (first: Row, second: Row) => {
    if (first.side === second.side) return [first.outer, second.outer];
    const pair = new Set([clean(first.side), clean(second.side)]), corner = pair.has("TOP") && pair.has("LEFT") ? [44, 86] : pair.has("TOP") && pair.has("RIGHT") ? [916, 86] : pair.has("BOTTOM") && pair.has("LEFT") ? [44, 438] : pair.has("BOTTOM") && pair.has("RIGHT") ? [916, 438] : null;
    if (corner) return [first.outer, corner, second.outer];
    if (pair.has("TOP") && pair.has("BOTTOM")) { const left = Math.abs(Number(first.outer[0]) - 44) + Math.abs(Number(second.outer[0]) - 44), right = Math.abs(Number(first.outer[0]) - 916) + Math.abs(Number(second.outer[0]) - 916); return left <= right ? [first.outer, [44, Number(first.outer[1])], [44, Number(second.outer[1])], second.outer] : [first.outer, [916, Number(first.outer[1])], [916, Number(second.outer[1])], second.outer]; }
    const top = Math.abs(Number(first.outer[1]) - 86) + Math.abs(Number(second.outer[1]) - 86), bottom = Math.abs(Number(first.outer[1]) - 438) + Math.abs(Number(second.outer[1]) - 438); return top <= bottom ? [first.outer, [Number(first.outer[0]), 86], [Number(second.outer[0]), 86], second.outer] : [first.outer, [Number(first.outer[0]), 438], [Number(second.outer[0]), 438], second.outer];
  };
  const length = (points: number[][]) => points.slice(1).reduce((total, point, index) => total + Math.abs(point[0] - points[index][0]) + Math.abs(point[1] - points[index][1]), 0), combinations = escapes(a).flatMap((first) => escapes(b).map((second) => { const edge = perimeter(first, second), points = [first.port, ...edge, second.port].filter((point, index, list) => index === 0 || point[0] !== list[index - 1][0] || point[1] !== list[index - 1][1]); return { route: `${first.side}_PERIMETER_${second.side}`, points, length: length(points) }; }));
  combinations.sort((left, right) => left.length - right.length || clean(left.route).localeCompare(clean(right.route)) || relationshipIndex);
  const selected = combinations[0];
  return { route: selected?.route || "PERIMETER_ESCAPE_UNSOLVED", corridor: selected?.points || [] };
}

function systemicLayoutMeasurement(spec: Row) {
  const objects = arr(spec.objects).map(rec), relationships = arr(spec.relationships).map(rec), inset = Number(rec(spec.canvas).safeInset || 40);
  const boxes = objects.map((item) => ({ id: clean(item.id), label: clean(item.label), ...rec(item.geometry) })).map((item) => ({ ...item, x: Number(item.x), y: Number(item.y), w: Number(item.w), h: Number(item.h) }));
  const overlap = (a: Row, b: Row) => Number(a.x) < Number(b.x) + Number(b.w) && Number(a.x) + Number(a.w) > Number(b.x) && Number(a.y) < Number(b.y) + Number(b.h) && Number(a.y) + Number(a.h) > Number(b.y);
  let objectOverlapCount = 0;
  for (let i = 0; i < boxes.length; i += 1) for (let j = i + 1; j < boxes.length; j += 1) if (overlap(boxes[i], boxes[j])) objectOverlapCount += 1;
  const clippingCount = boxes.filter((box) => box.x < inset || box.y < inset || box.x + box.w > 960 - inset || box.y + box.h > 486).length;
  const textOcclusionCount = boxes.filter((box) => {
    const charactersPerLine = Math.max(8, Math.floor((box.w - 28) / 12));
    return box.label.length > charactersPerLine * 2 || box.h < 60;
  }).length;
  const primitiveEgressFailures = boxes.filter((box) => {
    const others = boxes.filter((candidate) => candidate.id !== box.id), cx = box.x + box.w / 2, cy = box.y + box.h / 2;
    const verticalBlocked = (startY: number, endY: number) => others.some((candidate) => cx > candidate.x && cx < candidate.x + candidate.w && Math.max(Math.min(startY, endY), candidate.y) < Math.min(Math.max(startY, endY), candidate.y + candidate.h));
    const horizontalBlocked = (startX: number, endX: number) => others.some((candidate) => cy > candidate.y && cy < candidate.y + candidate.h && Math.max(Math.min(startX, endX), candidate.x) < Math.min(Math.max(startX, endX), candidate.x + candidate.w));
    return verticalBlocked(box.y, 86) && verticalBlocked(box.y + box.h, 438) && horizontalBlocked(box.x, 44) && horizontalBlocked(box.x + box.w, 916);
  }).length;
  const segmentIntersectsBox = (start: number[], end: number[], box: Row) => {
    if (start[0] === end[0]) return start[0] > Number(box.x) && start[0] < Number(box.x) + Number(box.w) && Math.max(Math.min(start[1], end[1]), Number(box.y)) < Math.min(Math.max(start[1], end[1]), Number(box.y) + Number(box.h));
    if (start[1] === end[1]) return start[1] > Number(box.y) && start[1] < Number(box.y) + Number(box.h) && Math.max(Math.min(start[0], end[0]), Number(box.x)) < Math.min(Math.max(start[0], end[0]), Number(box.x) + Number(box.w));
    return false;
  };
  const connectorTextIntersectionCount = relationships.filter((relationship) => {
    const corridor = arr(relationship.corridor).map((point) => arr(point).map(Number));
    return corridor.slice(0, -1).some((point, index) => boxes.some((box) => ![clean(relationship.from), clean(relationship.to)].includes(box.id) && segmentIntersectsBox(point, corridor[index + 1], box)));
  }).length;
  const unsolvedConnectorCount = relationships.filter((relationship) => arr(relationship.corridor).length < 2 || clean(relationship.route) === "PERIMETER_ESCAPE_UNSOLVED").length;
  const mobileLegibilityFailures = boxes.filter((box) => box.label.length > 22 || box.w < 150 || box.h < 60).length;
  const motionPositions = arr(rec(spec.motionProof).positions).map((point) => arr(point).map(Number)), movingLabel = clean(rec(spec.movingObject).label), movingHalfWidth = Math.max(22, movingLabel.length * 4), movingHalfHeight = 22;
  const motionPathObjectIntersectionCount = motionPositions.filter((point) => boxes.some((box) => point[0] + movingHalfWidth > box.x && point[0] - movingHalfWidth < box.x + box.w && point[1] + movingHalfHeight > box.y && point[1] - movingHalfHeight < box.y + box.h)).length;
  const motionPathSafeAreaFailures = motionPositions.filter((point) => point[0] - movingHalfWidth < inset || point[0] + movingHalfWidth > 960 - inset || point[1] - movingHalfHeight < inset || point[1] + movingHalfHeight > 540 - inset).length;
  return { clippingCount, textOcclusionCount, connectorTextIntersectionCount, unsolvedConnectorCount, primitiveEgressFailures, objectOverlapCount, mobileLegibilityFailures, motionPathObjectIntersectionCount, motionPathSafeAreaFailures, minimumGlyphScale: 2, allGeometryInsideSafeArea: clippingCount === 0 && motionPathSafeAreaFailures === 0, connectorCorridorsReserved: connectorTextIntersectionCount === 0 && unsolvedConnectorCount === 0, everyPrimitiveHasEgressPort: primitiveEgressFailures === 0, motionRailReserved: motionPathObjectIntersectionCount === 0, measuredFromSolvedGeometry: true };
}
...
function contractNativeSceneSpecification(contract: Row, bindings: Row[], actors: string[], kind: string) {
  ...
  const layoutFamily = SYSTEMIC_LAYOUT_FAMILIES[Math.abs(ordinal) % SYSTEMIC_LAYOUT_FAMILIES.length];
  const clauses = bindings.map((binding) => clean(binding.clause)).filter(Boolean), exactCorpus = `${clean(contract.claim)} ${clauses.join(" ")}`, corpus = exactCorpus.toUpperCase();
  const semanticTopology = systemicSemanticTopology(corpus);
  const primitiveRegistry = ["CARDHOLDER", "MERCHANT", "PROCESSOR OR ACQUIRER", "PROCESSOR", "ACQUIRER", "NETWORK", "ISSUER", "MERCHANT TERMINAL", "ISSUER LEDGER", "NETWORK TRAY", "NETWORK WORKSPACE", "ECONOMIC LANE", "INTERCHANGE", "NETWORK AND SERVICE FEES", "AUTHORIZATION REQUEST", "RESPONSE PACKET", "REQUEST PACKET", "CONTROLLED SCENARIO", "SOURCE SCHEDULE", "PRODUCT", "CATEGORY", "CHANNEL", "DATE", "STANDARD MODEL", "INTEGRATED EXCEPTION", "FIVE POSITION MAP", "WARNING RAIL", "BOUNDARY SHUTTER"] as const;
  const actorOrder = ["CARDHOLDER", "MERCHANT", "PROCESSOR OR ACQUIRER", "PROCESSOR", "ACQUIRER", "NETWORK", "ISSUER"];
  const detected = primitiveRegistry.filter((label) => corpus.includes(label));
  const bindingLabels = bindings.flatMap((binding) => arr(binding.nodes).map(clean)).filter((label) => label.length >= 3);
  const labels = [...new Set([...detected, ...actors.map(clean), ...bindingLabels])].map((label) => label.slice(0, 22)).slice(0, 6);
  while (labels.length < 3) labels.push(["SOURCE", "EVIDENCE", "OUTCOME"][labels.length]);
  const slots = systemicLayoutSlots(layoutFamily, labels.length), railY = 458;
  const objects = labels.map((label, index) => {
    const geometry = slots[index], type = actorOrder.includes(label) ? "ACTOR" : /BOUNDARY|SHUTTER|RAIL/.test(label) ? "BOUNDARY" : /LEDGER|TRAY|WORKSPACE|LANE|SCENARIO|SCHEDULE|MODEL|MAP|EXCEPTION/.test(label) ? "CONTAINER" : /INTERCHANGE|FEE/.test(label) ? "VALUE" : /REQUEST|RESPONSE/.test(label) ? "PACKET" : "EVIDENCE";
  ...
  const actions = bindings.map((binding, index) => clean(binding.relation) === "CONTRACT RELATION" ? ["CONTEXT ESTABLISHED", "RELATION ACTIVATED", "OUTCOME HELD"][index] : clean(binding.relation).slice(0, 28));
  const relationships = bindings.map((binding, index) => {
    const from = objects[index % objects.length], to = objects[(index + 1) % objects.length], solvedRoute = systemicRelationshipCorridor(from, to, objects, index);
    return { id: `RELATION_${index + 1}`, from: from.id, to: to.id, relation: actions[index], polarity: clean(binding.polarity), sourceClause: clean(binding.clause), routingPolicy: "OBSTACLE_AVOIDING_PERIMETER_PORTS", route: solvedRoute.route, corridor: solvedRoute.corridor };
  });
  const path = systemicMotionPath(objects, semanticTopology, railY);
  const movingLabel = (/RESPONSE/.test(corpus) ? "RESPONSE" : /REQUEST/.test(corpus) ? "REQUEST" : /FEE/.test(corpus) ? "FEES" : /INTERCHANGE/.test(corpus) ? "INTERCHANGE" : /SCENARIO/.test(corpus) ? "SCENARIO" : labels.find((label) => !actorOrder.includes(label)) || "EVIDENCE").slice(0, 16);
  const states = bindings.map((binding, index) => ({ role: ["ENTRY", "MIDPOINT", "EXIT"][index], visibleObjectIds: objects.map((item) => item.id), activeRelationshipId: relationships[index].id, movingObjectPosition: path[index], action: actions[index], constraint: clean(binding.polarity) === "NEGATIVE_CONSTRAINT" ? "CONSTRAINT HOLDS" : "EVIDENCE BOUND", stateDelta: actions[index] }));
  const base: Row = { version: "CONSTRAINT_SCENE_SPECIFICATION_V19", processVersion: "ROOT_CAUSE_TO_PROCESS_V1", processRevision: WAVE_BATCH_2_V19_PROCESS_REVISION, semanticTopology, layoutFamily, composition: `${semanticTopology}_${layoutFamily}`, canvas: { width: 960, height: 540, safeInset: 40 }, objects, movingObject: { id: "MOVING_OBJECT", type: "MOVING_EVIDENCE", label: movingLabel, sourceClause: clauses[1] || clauses[0] || clean(contract.claim), audienceVisible: true }, relationships, states, traceability: { contractId: clean(contract.briefId), claim: clean(contract.claim), clauses, objectCoverage: objects.map((item) => ({ objectId: item.id, sourceClause: item.sourceClause })), relationshipCoverage: relationships.map((item) => ({ relationshipId: item.id, sourceClause: item.sourceClause })) }, motionProof: { movingObjectId: "MOVING_OBJECT", positions: path, pathSolver: "TOPOLOGY_DIRECTED_DISTINCT_ANCHORS", physicalPositionDelta: new Set(path.map((point) => JSON.stringify(point))).size === 3, relationshipProgressionVisible: true, labelSwapOnlyForbidden: true }, rendererContract: { input: "CONSTRAINT_SOLVED_PRIMITIVES_ONLY", logicalIdBranchingForbidden: true, auditSampleBranchingForbidden: true, tokenFallbackForbidden: true, geometryAuthoritative: true, audienceTextBudget: { objectGlyphs: 22, actionGlyphs: 28, contractClausePixelsForbidden: true }, provenanceRequiredForEveryVisibleObject: true, provenanceRequiredForEveryRelationship: true } };
  return { ...base, layoutProof: systemicLayoutMeasurement(base) };
}
  ...
  if(contractNativeScene){
    ...
    if(auditedComposition){
      ...
      if(composition==="ISSUER_LEDGER_CONTAINMENT"){
        ...
        const ix=[126,438,714][state];nativeCard(ix,270,112,54,"INTERCHANGE",true);if(state===1)nativeArrow(250,360,430,360,true);
        ...
        if(state===0){fill(450,190,24,70,"#e8b65d");fill(450,320,24,70,"#e8b65d");center("OPEN",462,280,2,"#fff0df",8);}else{fill(450,190,24,200,"#e8b65d");for(let s=0;s<7;s++)fill(432,204+s*26,60,8,s%2?"#593823":"#fff0df");}center("SHUTTER",462,404,2,"#e8b65d",12);
        ...
        fill(560,202,330,172,"#e9eef8");center("NETWORK TRAY",725,220,3,"#102e55",18);if(state===0)center("EMPTY",725,292,4,"#52766b",8);else{const feeX=state===1?540:604;fill(feeX,276,state===1?300:242,72,"#ffffff");center("NETWORK AND",feeX+(state===1?150:121),286,2,"#102e55",20);center("SERVICE FEES",feeX+(state===1?150:121),320,2,"#102e55",18);}
        ...
        const pins=rec(spec.assumptionPins),cols=["PRODUCT","CATEGORY","CHANNEL","DATE"];fill(54,128,392,288,"#ffffff");fill(54,128,392,64,"#43356b");center("SCHEDULE",250,146,4,"#f3eaff",12);cols.forEach((label,index)=>{const y=214+index*44;text(label,76,y,2,"#25183a");text(clean(pins[label])==="SOURCE-BOUND"?"PIN":clean(pins[label]),286,y,2,"#43356b");});
        const cardX=state===2?486:520,cardW=state===2?420:360;fill(cardX,128,cardW,288,state===0?"#efeaf2":"#ffffff");fill(cardX,128,cardW,64,"#25183a");center("SCENARIO",cardX+cardW/2,146,4,"#f3eaff",12);if(state===0)center("EMPTY",cardX+cardW/2,286,5,"#a899b4",8);else cols.forEach((label,index)=>{const y=216+index*42;text(label,cardX+24,y,2,"#25183a");});if(state===2){line(cardX-8,120,cardX+cardW+8,120,8,"#d6a6ff");line(cardX-8,424,cardX+cardW+8,424,8,"#d6a6ff");line(cardX-8,120,cardX-8,424,8,"#d6a6ff");line(cardX+cardW+8,120,cardX+cardW+8,424,8,"#d6a6ff");}
      }else{
        if(composition==="MERCHANT_TO_PROCESSOR_BOUNDARY"){
          fill(64,154,300,220,"#fff4d8");center("MERCHANT",214,178,4,"#593823",16);center("TERMINAL",214,226,4,"#593823",16);fill(118,292,192,52,"#ffffff");center("REQUEST",214,306,2,"#593823",12);
          fill(390,154,180,220,"#e4f5eb");center("INFO LANE",480,178,3,"#174448",12);fill(428,278,104,52,"#ffffff");center("INFO",480,292,2,"#174448",8);
          ...
          circle(154,296,88,"#f2a65a");center("MERCHANT",154,290,2,"#342014",14);if(state===0)fill(388,160,34,244,"#102e55");else{fill(388,160,34,90,"#102e55");fill(388,350,34,54,"#102e55");center("OPEN",405,272,3,"#83c5ff",8);}text("BOUNDARY",360,448,2,"#e3f0ff");fill(568,166,318,220,"#e9eef8");center("PROCESSOR OR",727,194,3,"#102e55",18);center("ACQUIRER",727,242,3,"#102e55",14);
          const pulseX=[206,486,686][state];circle(pulseX,318,18,"#83c5ff");if(state>=1)nativeArrow(236,390,pulseX-30,390,true);if(state===2){fill(630,286,194,52,"#ffffff");center("REQUEST AT REST",727,300,2,"#102e55",20);}
...
function renderWaveSemanticScene(manifest: Row, state: 0 | 1 | 2) {
  const semantic = rec(manifest.semanticModel);
  if (clean(semantic.version) !== "CONSTRAINT_SCENE_SPECIFICATION_V19") return renderWaveSemanticSceneLegacy(manifest, state);
  const width = 960, height = 540, pixels = new Uint8Array(width * height * 4), raw = new Uint8Array(height * (1 + width * 4));
  const color = (hex: string) => [Number.parseInt(hex.slice(1, 3), 16), Number.parseInt(hex.slice(3, 5), 16), Number.parseInt(hex.slice(5, 7), 16), 255] as const;
  const fill = (x: number, y: number, w: number, h: number, hex: string) => { const c = color(hex); for (let py = Math.max(0, Math.round(y)); py < Math.min(height, Math.round(y + h)); py += 1) for (let px = Math.max(0, Math.round(x)); px < Math.min(width, Math.round(x + w)); px += 1) { const index = (py * width + px) * 4; pixels.set(c, index); } };
  const circle = (cx: number, cy: number, radius: number, hex: string) => { for (let y = -radius; y <= radius; y += 1) for (let x = -radius; x <= radius; x += 1) if (x * x + y * y <= radius * radius) fill(cx + x, cy + y, 1, 1, hex); };
  const text = (value: string, x: number, y: number, scale: number, hex: string) => { const c = color(hex); let cursor = x; for (const char of value.toUpperCase()) { const glyph = glyphs[char] || glyphs["?"]; for (let gy = 0; gy < 7; gy += 1) for (let gx = 0; gx < 5; gx += 1) if (glyph[gy][gx] === "1") for (let sy = 0; sy < scale; sy += 1) for (let sx = 0; sx < scale; sx += 1) { const px = cursor + gx * scale + sx, py = y + gy * scale + sy; if (px >= 0 && px < width && py >= 0 && py < height) { const index = (py * width + px) * 4; pixels.set(c, index); } } cursor += 6 * scale; } };
  const safe = (value: unknown, maximum = 22) => clean(value).toUpperCase().replace(/[^A-Z0-9$+\-.:? ]/g, " ").replace(/\s+/g, " ").trim().slice(0, maximum);
  const center = (value: unknown, cx: number, y: number, scale: number, hex: string, maximum = 22) => { const label = safe(value, maximum); text(label, Math.max(8, Math.round(cx - label.length * 3 * scale)), y, scale, hex); };
  const line = (x1: number, y1: number, x2: number, y2: number, thickness: number, hex: string) => { const steps = Math.max(Math.abs(x2 - x1), Math.abs(y2 - y1)); for (let index = 0; index <= steps; index += 1) { const progress = steps ? index / steps : 0; fill(Math.round(x1 + (x2 - x1) * progress) - Math.floor(thickness / 2), Math.round(y1 + (y2 - y1) * progress) - Math.floor(thickness / 2), thickness, thickness, hex); } };
  const wrap = (value: unknown, widthPixels: number) => { const words = safe(value, 22).split(" ").filter(Boolean), limit = Math.max(8, Math.floor((widthPixels - 24) / 12)), lines = [""]; for (const word of words) { const candidate = `${lines[lines.length - 1]} ${word}`.trim(); if (candidate.length <= limit || lines.length === 2) lines[lines.length - 1] = candidate; else lines.push(word); } return lines.slice(0, 2); };
  const spec = rec(semantic.sceneSpecification), sceneState = rec(arr(spec.states)[state]), objects = arr(spec.objects).map(rec), relationships = arr(spec.relationships).map(rec), active = relationships.find((item) => clean(item.id) === clean(sceneState.activeRelationshipId)) || relationships[state], position = arr(sceneState.movingObjectPosition).map(Number), family = clean(spec.layoutFamily), topology = clean(spec.semanticTopology);
  const familyIndex = Math.max(0, SYSTEMIC_LAYOUT_FAMILIES.indexOf(family as typeof SYSTEMIC_LAYOUT_FAMILIES[number]));
  const palettes = [
    ["#0b1f33", "#e8f1f8", "#4cc9f0", "#102a43"], ["#10261f", "#e8f5ef", "#65c18c", "#153f32"], ["#2a1812", "#fff0df", "#ff9f68", "#512b1e"], ["#1e1833", "#f0eaff", "#bd9cff", "#352653"], ["#10212b", "#e8f4f8", "#57c7d4", "#173b46"], ["#2a2411", "#fff7d6", "#e8bd45", "#54451d"], ["#29151f", "#fbe9f0", "#ee7aa8", "#552439"], ["#0d2a2a", "#e2f5f2", "#67c8bd", "#164846"], ["#202020", "#f2f2ed", "#a7d66d", "#3a3a36"], ["#24183a", "#f3eaff", "#d6a6ff", "#433064"],
  ] as const;
  const [background, surface, accent, ink] = palettes[familyIndex];
  fill(0, 0, width, height, background);
  if (family === "SWIMLANE") for (let lane = 0; lane < 3; lane += 1) fill(36, 104 + lane * 124, 888, 100, lane % 2 ? ink : background);
  if (family === "TIMELINE") line(72, 286, 888, 286, 10, accent);
  if (family === "MATRIX") { line(480, 92, 480, 432, 5, accent); line(44, 266, 916, 266, 5, accent); }
  if (family === "LEDGER") { fill(38, 92, 414, 342, ink); fill(508, 92, 414, 342, ink); }
  if (family === "TABLE") for (let row = 0; row < 5; row += 1) line(44, 102 + row * 76, 916, 102 + row * 76, 3, ink);
  objects.forEach((object) => {
    const box = rec(object.geometry), x = Number(box.x), y = Number(box.y), w = Number(box.w), h = Number(box.h), type = clean(object.type), labelLines = wrap(object.label, w), activeObject = arr(sceneState.visibleObjectIds).map(clean).includes(clean(object.id));
    if (type === "ACTOR" && family === "RADIAL") { circle(x + w / 2, y + h / 2, Math.min(46, h / 2), activeObject ? accent : ink); center(labelLines[0], x + w / 2, y + h / 2 - 8, 2, background, 12); if (labelLines[1]) center(labelLines[1], x + w / 2, y + h / 2 + 18, 2, background, 12); return; }
    if (type === "BOUNDARY") { fill(x + w / 2 - 10, y, 20, h, accent); for (let mark = 0; mark < Math.max(2, Math.floor(h / 28)); mark += 1) fill(x + w / 2 - 22, y + 8 + mark * 26, 44, 7, mark % 2 ? background : surface); center(labelLines[0], x + w / 2, y + h + 8, 1, surface, 18); return; }
    fill(x, y, w, h, activeObject ? surface : ink); fill(x, y, w, 9, activeObject ? accent : background);
    if (type === "CONTAINER") { fill(x + 14, y + 22, w - 28, Math.max(18, h - 36), background); fill(x + 22, y + 30, w - 44, Math.max(10, h - 52), activeObject ? surface : ink); }
    const textColor = activeObject ? background : surface, baseY = y + Math.max(18, Math.round(h / 2) - (labelLines.length === 2 ? 18 : 8));
    center(labelLines[0], x + w / 2, baseY, 2, textColor, 18); if (labelLines[1]) center(labelLines[1], x + w / 2, baseY + 28, 2, textColor, 18);
  });
  if (active) { const corridor = arr(active.corridor).map((point) => arr(point).map(Number)); for (let index = 0; index < corridor.length - 1; index += 1) line(corridor[index][0], corridor[index][1], corridor[index + 1][0], corridor[index + 1][1], 7, clean(active.polarity) === "NEGATIVE_CONSTRAINT" ? "#ffb36b" : accent); if (corridor.length) circle(corridor[corridor.length - 1][0], corridor[corridor.length - 1][1], 10, accent); }
  const movingX = Number(position[0] || 480), movingY = Number(position[1] || 472); circle(movingX, movingY, 22, accent); center(rec(spec.movingObject).label, movingX, movingY - 5, 1, background, 16);
  center(clean(sceneState.action), 480, 510, 2, surface, 28);
  if (topology === "NEGATIVE_CONSTRAINT") { fill(44, 36, 300, 38, "#5b2d1c"); center("CONSTRAINT HOLDS", 194, 48, 2, "#fff0df", 18); }
  for (let y = 0; y < height; y += 1) { const row = y * (1 + width * 4); raw[row] = 0; raw.set(pixels.subarray(y * width * 4, (y + 1) * width * 4), row + 1); }
  const ihdr = new Uint8Array(13); ihdr.set(u32(width), 0); ihdr.set(u32(height), 4); ihdr.set([8, 6, 0, 0, 0], 8);
  const bytes = joinBytes([new Uint8Array([137, 80, 78, 71, 13, 10, 26, 10]), pngChunk("IHDR", ihdr), pngChunk("IDAT", deflateStored(raw)), pngChunk("IEND", new Uint8Array())]);
...
function waveProductOracle(manifest: Row) {
  ...
  const checks=[
    ...
    {id:"CONTRACT_NATIVE_SCENE_SPECIFICATION",status:!contractNativeScene||clean(sceneSpec.version)==="CONSTRAINT_SCENE_SPECIFICATION_V19"&&clean(sceneSpec.processVersion)==="ROOT_CAUSE_TO_PROCESS_V1"&&clean(sceneSpec.processRevision)===WAVE_BATCH_2_V19_PROCESS_REVISION&&Boolean(clean(sceneSpec.semanticTopology))&&Boolean(clean(sceneSpec.composition))&&sceneObjects.length>=3&&sceneObjects.length<=6&&sceneRelationships.length===3&&sceneStates.length===3&&sceneObjects.every((item)=>Boolean(clean(item.id))&&Boolean(clean(item.type))&&Boolean(clean(item.label))&&Boolean(clean(item.sourceClause))&&Object.keys(rec(item.geometry)).length===4)&&sceneRelationships.every((item)=>Boolean(clean(item.from))&&Boolean(clean(item.to))&&Boolean(clean(item.relation))&&Boolean(clean(item.sourceClause)))?"PASS":"FAIL",evidence:`${sceneObjects.length} domain primitives · ${sceneRelationships.length} actions · ${sceneStates.length} states · ${clean(sceneSpec.processRevision)}`},
    {id:"SCENE_SPEC_TO_PIXEL_TRACE",status:!contractNativeScene||sceneStates.every((item)=>arr(item.visibleObjectIds).length>=3&&Boolean(clean(item.activeRelationshipId))&&arr(item.movingObjectPosition).length===2)&&rendererContract.input==="CONSTRAINT_SOLVED_PRIMITIVES_ONLY"&&rendererContract.logicalIdBranchingForbidden===true&&rendererContract.auditSampleBranchingForbidden===true&&rendererContract.tokenFallbackForbidden===true&&rendererContract.geometryAuthoritative===true?"PASS":"FAIL",evidence:"renderer consumes only systemic semantic topology and constraint-solved primitives"},
    {id:"SCENE_SPEC_LAYOUT_SAFETY",status:!contractNativeScene||Number(sceneLayoutProof.clippingCount)===0&&Number(sceneLayoutProof.textOcclusionCount)===0&&Number(sceneLayoutProof.connectorTextIntersectionCount)===0&&Number(sceneLayoutProof.unsolvedConnectorCount)===0&&Number(sceneLayoutProof.primitiveEgressFailures)===0&&Number(sceneLayoutProof.objectOverlapCount)===0&&Number(sceneLayoutProof.mobileLegibilityFailures)===0&&Number(sceneLayoutProof.motionPathObjectIntersectionCount)===0&&Number(sceneLayoutProof.motionPathSafeAreaFailures)===0&&sceneLayoutProof.allGeometryInsideSafeArea===true&&sceneLayoutProof.connectorCorridorsReserved===true&&sceneLayoutProof.everyPrimitiveHasEgressPort===true&&sceneLayoutProof.motionRailReserved===true&&sceneLayoutProof.measuredFromSolvedGeometry===true?"PASS":"FAIL",evidence:"layout proof is recomputed from solved geometry, including primitive egress, full connector segments, mobile legibility and motion-path exclusion"},
...
function waveManifestQualification(manifest: Row) {
  const states=arr(manifest.states).map(rec),semantic=rec(manifest.semanticModel),required=arr(semantic.requiredElements).map(clean).filter(Boolean),contractNativeScene=clean(semantic.version)==="CONSTRAINT_SCENE_SPECIFICATION_V19",structuredOntology=clean(semantic.version)==="STRUCTURED_VISUAL_ONTOLOGY_V12",semanticProjection=clean(semantic.version)==="CONTRACT_SEMANTIC_PROJECTION_V11"||structuredOntology||contractNativeScene,archetypeBound=clean(semantic.version)==="ARCHETYPE_SEMANTIC_MANIFEST_V10"||semanticProjection,contractBound=clean(semantic.version)==="CONTRACT_BOUND_SCENE_GRAPH_V9"||archetypeBound,bindings=arr(semantic.stateBindings).map(rec),projections=arr(semantic.stateProjection).map(rec),ontology=rec(semantic.visualOntology),ontologyStates=arr(ontology.states).map(rec),layoutProof=rec(ontology.layoutProof),motionPolicy=rec(ontology.motionPolicy),sceneSpec=rec(semantic.sceneSpecification),sceneObjects=arr(sceneSpec.objects).map(rec),sceneRelationships=arr(sceneSpec.relationships).map(rec),sceneStates=arr(sceneSpec.states).map(rec),sceneLayoutProof=rec(sceneSpec.layoutProof),sceneMotionProof=rec(sceneSpec.motionProof),rendererContract=rec(sceneSpec.rendererContract),corpus=clean(semantic.corpusHashInput).toUpperCase(),genericEscape=contractBound&&["$100 PURCHASE","REWARD ENTRY"].some((term)=>required.includes(term)&&!corpus.includes(term)),provenance=arr(semantic.elementProvenance).map(rec),transitions=arr(semantic.transitionModel).map(rec),layout=rec(manifest.layoutPolicy),checks=[
    {id:"SEMANTIC_SCENE_GRAPH",status:["CONTRACT_SIGNATURE_SCENE_GRAPH_V5_SPATIAL_BOUND","CONTRACT_BOUND_SCENE_GRAPH_V9","ARCHETYPE_SEMANTIC_MANIFEST_V10","CONTRACT_SEMANTIC_PROJECTION_V11","STRUCTURED_VISUAL_ONTOLOGY_V12","CONSTRAINT_SCENE_SPECIFICATION_V19"].includes(clean(semantic.version))&&required.length>=3?"PASS":"FAIL"},
    ...
    {id:"SCENE_SPEC_TO_PIXEL_TRACE",status:!contractNativeScene||sceneStates.every((item)=>arr(item.visibleObjectIds).length>=3&&arr(item.movingObjectPosition).length===2)&&rendererContract.input==="CONSTRAINT_SOLVED_PRIMITIVES_ONLY"&&rendererContract.logicalIdBranchingForbidden===true&&rendererContract.auditSampleBranchingForbidden===true&&rendererContract.tokenFallbackForbidden===true?"PASS":"FAIL"},
    {id:"SCENE_SPEC_LAYOUT_SAFETY",status:!contractNativeScene||Number(sceneLayoutProof.clippingCount)===0&&Number(sceneLayoutProof.textOcclusionCount)===0&&Number(sceneLayoutProof.connectorTextIntersectionCount)===0&&Number(sceneLayoutProof.unsolvedConnectorCount)===0&&Number(sceneLayoutProof.primitiveEgressFailures)===0&&Number(sceneLayoutProof.objectOverlapCount)===0&&Number(sceneLayoutProof.mobileLegibilityFailures)===0&&Number(sceneLayoutProof.motionPathObjectIntersectionCount)===0&&Number(sceneLayoutProof.motionPathSafeAreaFailures)===0&&sceneLayoutProof.allGeometryInsideSafeArea===true&&sceneLayoutProof.connectorCorridorsReserved===true&&sceneLayoutProof.everyPrimitiveHasEgressPort===true&&sceneLayoutProof.motionRailReserved===true&&sceneLayoutProof.measuredFromSolvedGeometry===true?"PASS":"FAIL"},
...
function systemicRootCauseRecord(audit: Row) {
  const root = rec(JSON.parse(String(audit.root_cause_json || "{}"))), findings = arr(JSON.parse(String(audit.findings_json || "[]"))).map(rec);
  return {
    status: "ROOT_CAUSE_VERIFIED",
    incident: "BATCH_2_V18_LAYOUT_AND_PORTFOLIO_PROCESS_ESCAPE",
    observedAuditScore: Number(audit.score || 0),
    observedRootProductionCause: clean(root.rootProductionCause),
    evidence: findings.map((item) => ({ logicalId: clean(item.logicalId), severity: clean(item.severity), category: clean(item.category), productionLayer: clean(item.productionLayer), summary: clean(item.summary) })),
    causalMechanism: "MONOLITHIC_SAMPLE_BRANCH_RENDERER_PLUS_SELF_ATTESTED_LAYOUT_PROOF",
    escapePoint: "PREFLIGHT_TRUSTED_COMPILER_DECLARATIONS_AND_HASH_COUNTS_INSTEAD_OF_REMEASURING_SOLVED_GEOMETRY_AND_MOBILE_CONSTRAINTS",
    systemicPreflightLearning: [{ priorProcessRevision: "V19_INITIAL", result: "5_OF_10_ADVERSARIAL_FIXTURES_PASS", rootCause: "MOTION_PATH_INHERITED_DUPLICATE_LAYOUT_SLOT_CENTERS_AND_LAYOUT_CAPACITY_COULD_BE_SMALLER_THAN_SEMANTIC_OBJECT_COUNT", escapePoint: "MOTION_PATH_DELTA_AND_SLOT_CAPACITY_WERE_NOT_SEPARATE_SOLVER_INVARIANTS", evidencePreserved: true }, { priorProcessRevision: "V19_1_CAPACITY_SAFE_MOTION_PATH_SOLVER", result: "0_OF_10_ADVERSARIAL_FIXTURES_PASS", rootCause: "FULL_SEGMENT_MEASUREMENT_PROVED_CONNECTORS_CROSSED_INTERMEDIATE_PRIMITIVES", escapePoint: "CONNECTOR_ROUTING_DID_NOT_SOLVE_AGAINST_OBSTACLE_GEOMETRY", evidencePreserved: true }, { priorProcessRevision: "V19_2_OBSTACLE_AVOIDING_CONNECTOR_SOLVER", result: "9_OF_10_ADVERSARIAL_AND_46_OF_50_LAYOUT_SAFE", rootCause: "TABLE_FAMILY_SURROUNDED_ONE_PRIMITIVE_WITHOUT_ANY_CONNECTOR_EGRESS_PORT", escapePoint: "LAYOUT_CAPACITY_DID_NOT_REQUIRE_EGRESS_COMPLETENESS_FOR_EVERY_PRIMITIVE", evidencePreserved: true }],
    affectedProcessSteps: ["SEMANTIC_TOPOLOGY_CLASSIFICATION", "LAYOUT_SOLVING", "PRIMITIVE_RENDERING", "MEASURED_PREFLIGHT", "PORTFOLIO_PLANNING"],
    prohibitedCorrections: ["LOGICAL_ID_BRANCH", "AUDIT_SAMPLE_BRANCH", "FRAME_COORDINATE_PATCH", "OUTPUT_REPAIR", "COSMETIC_HASH_VARIETY"],
    systemicCorrections: ["TOPOLOGY_CLASSIFICATION_FROM_SOURCE_CLAUSES", "CONSTRAINT_SOLVED_GEOMETRY", "PRIMITIVE_ONLY_RENDERER", "RECOMPUTED_LAYOUT_AND_MOBILE_MEASUREMENTS", "TEN_STRUCTURAL_LAYOUT_LANGUAGES", "ADVERSARIAL_FIXTURE_QUALIFICATION", "CAPACITY_SAFE_SLOTS_AND_TOPOLOGY_DIRECTED_MOTION_PATH", "OBSTACLE_AVOIDING_CONNECTOR_PORT_AND_PERIMETER_SOLVER", "EGRESS_COMPLETE_PRIMITIVE_PLACEMENT"],
    acceptance: { fullPortfolioProducts: 50, fullPortfolioFrames: 150, layoutFamilies: 10, adversarialFixtures: 10, measuredFailuresMaximum: 0, motionPathObjectIntersectionsMaximum: 0, motionPathSafeAreaFailuresMaximum: 0, remoteRequests: 0 },
  };
}

function qualifySystemicAdversarialFixtures() {
  const fixtureClaims = [
    "Authorization request crosses a boundary from merchant terminal to processor while the economic lane remains closed",
    "Interchange remains in issuer ledger and does not become network revenue",
    "Network and service fees stay separate from interchange across two value containers",
    "Five position role system preserves cardholder merchant processor network and issuer",
    "Response packet returns from network through processor and merchant to merchant terminal",
    "Controlled scenario pins product category channel and date to the source schedule",
    "Negative constraint keeps network workspace untouched while evidence moves",
    "Evidence comparison keeps two records distinct and the causal origin unresolved",
    "Boundary shutter opens for information only and closes for economic value",
    "Source transforms into verified outcome through three explicit state transitions",
  ];
  const failures: Row[] = [];
  fixtureClaims.forEach((claim, index) => {
    const fixture: Row = { briefId: `SYSTEMIC-FIXTURE-${90 + index}`, claim, archetype: "SYSTEMIC_ADVERSARIAL", visualFamily: "CONSTRAINT", sectionId: "ROOT_CAUSE_REGRESSION" };
    const bindings = ([0, 1, 2] as const).map((state) => contractStateBinding(claim, ["ENTRY", "MIDPOINT", "EXIT"][state], claim));
    const spec = contractNativeSceneSpecification(fixture, bindings, ["MERCHANT", "PROCESSOR", "NETWORK", "ISSUER"], "SYSTEMIC_FIXTURE"), measured = systemicLayoutMeasurement(spec), renderer = rec(spec.rendererContract), motion = rec(spec.motionProof);
    if (Number(measured.clippingCount) !== 0 || Number(measured.textOcclusionCount) !== 0 || Number(measured.connectorTextIntersectionCount) !== 0 || Number(measured.unsolvedConnectorCount) !== 0 || Number(measured.primitiveEgressFailures) !== 0 || Number(measured.objectOverlapCount) !== 0 || Number(measured.mobileLegibilityFailures) !== 0 || Number(measured.motionPathObjectIntersectionCount) !== 0 || Number(measured.motionPathSafeAreaFailures) !== 0 || measured.connectorCorridorsReserved !== true || measured.everyPrimitiveHasEgressPort !== true || measured.motionRailReserved !== true || measured.measuredFromSolvedGeometry !== true || renderer.input !== "CONSTRAINT_SOLVED_PRIMITIVES_ONLY" || renderer.logicalIdBranchingForbidden !== true || renderer.auditSampleBranchingForbidden !== true || motion.physicalPositionDelta !== true) failures.push({ fixture: fixture.briefId, measured, motionPositions: motion.positions });
  });
  return { total: fixtureClaims.length, pass: fixtureClaims.length - failures.length, failures };
}
...
async function waveBatch2V13ActivationContext() {
  ...
  const usage = await db.prepare("SELECT COUNT(*) AS total,COALESCE(SUM(actual_cost_usd),0) AS cost FROM v7_material_requests WHERE authorization_id=?").bind(authorization.id).first<{ total: number; cost: number }>();
  const systemicRca = systemicRootCauseRecord(audit);
  const inputHash = await sha(JSON.stringify({ action: "ADOPT_WAVE_BATCH_2_V19_SYSTEMIC_PROCESS_CORRECTION", processRevision: WAVE_BATCH_2_V19_PROCESS_REVISION, runId: run.id, authorizationId: authorization.id, sourceBatchId: rejected.id, sourceBatchUpdatedAt: rejected.updated_at, sourceAuditId: audit.id, sourceAuditUpdatedAt: audit.updated_at, systemicRca, scope, targetVersion: WAVE_BATCH_2_V13_REPRODUCTION_VERSION, targetEngine: WAVE_BATCH_2_V13_ENGINE_VERSION }));
  return { env, db, run, authorization, replacementId, rejected, audit, systemicRca, scope, inputHash, requestsBefore: Number(usage?.total || 0), costBefore: Number(usage?.cost || 0) };
}
...
async function qualifyWaveBatch2V13Activation(context: Awaited<ReturnType<typeof waveBatch2V13ActivationContext>>, progress: Row = {}) {
  ...
  for (const target of scope.slice(startIndex, endIndex)) {
    ...
    const sceneSpecComplete = clean(spec.version) === "CONSTRAINT_SCENE_SPECIFICATION_V19" && clean(spec.processVersion) === "ROOT_CAUSE_TO_PROCESS_V1" && clean(spec.processRevision) === WAVE_BATCH_2_V19_PROCESS_REVISION && Boolean(clean(spec.semanticTopology)) && Boolean(clean(spec.composition)) && objects.length >= 3 && objects.length <= 6 && relationships.length === 3 && states.length === 3 && objects.every((item) => Boolean(clean(item.type)) && Boolean(clean(item.sourceClause)) && Object.keys(rec(item.geometry)).length === 4) && relationships.every((item) => Boolean(clean(item.sourceClause)));
    const pixelTraceComplete = states.every((item) => arr(item.visibleObjectIds).length >= 3 && Boolean(clean(item.activeRelationshipId)) && arr(item.movingObjectPosition).length === 2) && rendererContract.input === "CONSTRAINT_SOLVED_PRIMITIVES_ONLY" && rendererContract.logicalIdBranchingForbidden === true && rendererContract.auditSampleBranchingForbidden === true && rendererContract.tokenFallbackForbidden === true && rendererContract.geometryAuthoritative === true;
    ...
    const measured = systemicLayoutMeasurement(spec), layoutSafe = Number(measured.clippingCount) === 0 && Number(measured.textOcclusionCount) === 0 && Number(measured.connectorTextIntersectionCount) === 0 && Number(measured.unsolvedConnectorCount) === 0 && Number(measured.primitiveEgressFailures) === 0 && Number(measured.objectOverlapCount) === 0 && Number(measured.mobileLegibilityFailures) === 0 && Number(measured.motionPathObjectIntersectionCount) === 0 && Number(measured.motionPathSafeAreaFailures) === 0 && measured.allGeometryInsideSafeArea === true && measured.connectorCorridorsReserved === true && measured.everyPrimitiveHasEgressPort === true && measured.motionRailReserved === true && measured.measuredFromSolvedGeometry === true && JSON.stringify(measured) === JSON.stringify(layoutProof);
  ...
  const maximumFamilyShare = Math.max(0, ...familyCounts.values()) / Math.max(1, endIndex), complete = endIndex === scope.length, adversarial = complete ? qualifySystemicAdversarialFixtures() : { total: 10, pass: 0, failures: [] }, rootCauseGate = context.systemicRca.status === "ROOT_CAUSE_VERIFIED" && arr(context.systemicRca.prohibitedCorrections).length === 5 && arr(context.systemicRca.systemicCorrections).length === 9 && arr(context.systemicRca.systemicPreflightLearning).length === 3;
  const passed = complete && rootCauseGate && adversarial.pass === 10 && failures.length === 0 && productSignatures.size === 50 && frameSignatures.size === 150 && grammarSignatures.size === 50 && sceneSpecCoverage === 50 && pixelTraceCoverage === 50 && motionCoverage === 50 && layoutSafeCoverage === 50 && familyCounts.size === 10 && maximumFamilyShare <= 0.2;
  return { status: complete ? passed ? "PASS" : "FAIL" : "RUNNING", nextIndex: endIndex, total: scope.length, products: productSignatures.size, frames: frameSignatures.size, grammars: grammarSignatures.size, families: familyCounts.size, maximumFamilyShare, sceneSpecCoverage, pixelTraceCoverage, motionCoverage, layoutSafeCoverage, rootCauseGate, adversarialFixtures: adversarial.total, adversarialPass: adversarial.pass, adversarialFailures: adversarial.failures, failures, productSignatures: [...productSignatures], frameSignatures: [...frameSignatures], grammarSignatures: [...grammarSignatures], familyCounts: [...familyCounts], requestsDelta: 0, costDelta: 0 };
}

async function preflightWaveBatch2V13Activation() {
  const context = await waveBatch2V13ActivationContext(), now = new Date().toISOString(), preflightId = `${context.replacementId}-ZERO-SPEND-PREFLIGHT-V19-3`;
  const existing = await context.db.prepare("SELECT * FROM v7_batch_activation_preflights WHERE id=?").bind(preflightId).first<Row>();
  if (existing && clean(existing.input_hash) === context.inputHash && clean(existing.status) === "PASS") return snapshot();
  const prior = existing && clean(existing.input_hash) === context.inputHash && clean(existing.status) === "RUNNING" ? rec(JSON.parse(String(existing.result_json || "{}"))) : {};
  const result = await qualifyWaveBatch2V13Activation(context, prior);
  await context.db.prepare("INSERT INTO v7_batch_activation_preflights (id,program_id,run_id,authorization_id,action,source_batch_id,source_audit_id,target_batch_id,input_hash,status,result_json,requests_before,cost_before,created_at,updated_at) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ON CONFLICT(id) DO UPDATE SET source_batch_id=excluded.source_batch_id,source_audit_id=excluded.source_audit_id,input_hash=excluded.input_hash,status=excluded.status,result_json=excluded.result_json,requests_before=excluded.requests_before,cost_before=excluded.cost_before,updated_at=excluded.updated_at").bind(preflightId, PROGRAM_ID, context.run.id, context.authorization.id, "PREFLIGHT_WAVE_BATCH_2_V19_SYSTEMIC_ACTIVATION", context.rejected.id, context.audit.id, context.replacementId, context.inputHash, result.status, JSON.stringify(result), context.requestsBefore, context.costBefore, now, now).run();
  const readBack = await context.db.prepare("SELECT * FROM v7_batch_activation_preflights WHERE id=? AND input_hash=?").bind(preflightId, context.inputHash).first<Row>();
...
async function adoptWaveBatch2V13EngineRootCorrection() {
  const context = await waveBatch2V13ActivationContext(), activationId = `${context.replacementId}-ACTIVATION-V1`, preflightId = `${context.replacementId}-ZERO-SPEND-PREFLIGHT-V19-3`;
  const existingActivation = await context.db.prepare("SELECT * FROM v7_batch_activations WHERE id=?").bind(activationId).first<Row>();
  if (existingActivation) {
  ...
  const result = rec(JSON.parse(String(preflight.result_json || "{}")));
  if (result.rootCauseGate !== true || Number(result.adversarialFixtures) !== 10 || Number(result.adversarialPass) !== 10 || Number(result.products) !== 50 || Number(result.frames) !== 150 || Number(result.grammars) !== 50 || Number(result.sceneSpecCoverage) !== 50 || Number(result.pixelTraceCoverage) !== 50 || Number(result.motionCoverage) !== 50 || Number(result.layoutSafeCoverage) !== 50 || Number(result.families) !== 10 || Number(result.maximumFamilyShare) > 0.2 || Number(result.requestsDelta) !== 0 || Number(result.costDelta) !== 0) throw new Error("BATCH_2_V13_SYSTEMIC_PREFLIGHT_EVIDENCE_INCOMPLETE");
  const { db, run, authorization, rejected, audit, systemicRca, replacementId, scope, requestsBefore, costBefore } = context, now = new Date().toISOString(), priorRoot = rec(JSON.parse(String(audit.root_cause_json || "{}")));
  ...
  const rootCausePolicy = { ...rec(JSON.parse(String(rejected.root_cause_policy_json || "{}"))), ...systemicRca, processRevision: WAVE_BATCH_2_V19_PROCESS_REVISION, rejectedEngineVersion: WAVE_BATCH_2_V13_REJECTED_ENGINE_VERSION, rejectedAuditId: audit.id, rejectedAuditScore: Number(audit.score), observedRootCause: priorRoot.rootProductionCause, correctedLayers: systemicRca.affectedProcessSteps, correction: "REPLACE_SAMPLE_BRANCH_RENDERING_WITH_SEMANTIC_TOPOLOGY_CONSTRAINT_SOLVING_CAPACITY_SAFE_EGRESS_COMPLETE_SLOTS_TOPOLOGY_DIRECTED_MOTION_OBSTACLE_AVOIDING_CONNECTORS_AND_MEASURED_PREFLIGHT", replacementEngineVersion: WAVE_BATCH_2_V13_ENGINE_VERSION, fullScopeRegression: "50_PRODUCTS_150_FRAMES_10_ADVERSARIAL_FIXTURES_MEASURED", portfolioPolicy, reproduceScope: "ALL_50_PRODUCTS", outputRepair: false, failedV19InitialPreflightPreservedAsEvidence: true, failedV19_1PreflightPreservedAsEvidence: true, failedV19_2PreflightPreservedAsEvidence: true, v8V9V10V11V12V13V14V15V16V17V18ProductsPreservedAsEvidence: true, retryPriorAudits: false };
  const productionDoD = { ...rec(JSON.parse(String(rejected.production_dod_json || "{}"))), version: "SHOT_PRODUCT_DOD_V19_SYSTEMIC", processRevision: WAVE_BATCH_2_V19_PROCESS_REVISION, rootCauseVerifiedBeforeDesign: true, semanticTopologyClassification: true, constraintSolvedGeometry: true, capacitySafeSlots: true, everyPrimitiveHasEgressPort: true, topologyDirectedMotionPath: true, obstacleAvoidingConnectorSolver: true, primitiveOnlyRenderer: true, logicalIdBranchingForbidden: true, auditSampleBranchingForbidden: true, measuredLayoutProof: true, mobileLegibilityMeasured: true, fullConnectorSegmentIntersectionMeasured: true, primitiveEgressMeasured: true, motionPathObjectIntersectionMeasured: true, motionPathSafeAreaMeasured: true, adversarialFixtures: "10_OF_10_PASS", sharedDiagramShellForbidden: true, clippingConnectorTextAndObjectOverlapZero: true, portfolioPolicy, fullScopeRegression: "50_OF_50_PASS" };
  const modelPolicy = { ...rec(JSON.parse(String(authorization.model_policy_json || "{}"))), version: WAVE_BATCH_2_V13_REPRODUCTION_VERSION, productionEngine: WAVE_BATCH_2_V13_ENGINE_VERSION, scope: "REPRODUCE_ALL_50_AFTER_V18_ENGINE_REJECTION", deterministicProductionRequests: 0, independentAuditRequests: 1, autoRepair: false, priorAuditRetry: false, qaFailureRoute: "ROOT_PRODUCTION_PROCESS" };
  ...
  try {
    await db.batch([
      ...
      db.prepare("UPDATE v7_material_authorizations SET scope='WAVE_09_BATCH_2_ENGINE_V19_REPRODUCTION',status='PAUSED',shot_count=50,max_remote_requests=?,max_actual_spend_usd=?,model_policy_json=?,completed_at=NULL,updated_at=? WHERE id=?").bind(requestsBefore + 1, costBefore + 10, JSON.stringify(modelPolicy), now, authorization.id),
      db.prepare("UPDATE v7_material_runs SET status='BATCH_2_V19_REPRODUCING',mode='SYSTEMIC_CONSTRAINT_REPRODUCTION' WHERE id=?").bind(run.id),
      db.prepare("UPDATE v7_stage_states SET status='BATCH_2_V19_REPRODUCING',blocker='INTEGRATED_PRODUCTION_TRANSACTION',evidence_summary='V8-V18 evidence preserved · root cause verified · V19 systemic topology, constraint solver, primitive renderer, measured mobile/layout proof and 10 adversarial fixtures PASS · no output repair · prior audits not retried',updated_at=? WHERE id=?").bind(now, STAGE_ID),
      db.prepare("INSERT INTO v7_batch_activations (id,program_id,run_id,authorization_id,action,idempotency_key,target_batch_id,input_hash,status,result_json,created_at,committed_at,updated_at) VALUES (?,?,?,?,?,?,?,?, 'COMMITTED',?,?,?,?)").bind(activationId, PROGRAM_ID, run.id, authorization.id, "ADOPT_WAVE_BATCH_2_V19_SYSTEMIC_PROCESS_CORRECTION", activationId, replacementId, context.inputHash, JSON.stringify(activationResult), now, now, now),
    ]);
  } catch (error) {
...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (body.action === "PREFLIGHT_WAVE_BATCH_2_V19_SYSTEMIC_ACTIVATION") return Response.json(await preflightWaveBatch2V13Activation(), { status: 200 });

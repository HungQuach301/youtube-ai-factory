...
export const EVALUATION_RIGHTS_LINEAGE_DIAGNOSTIC_VERSION = "EVALUATION_RIGHTS_LINEAGE_DIAGNOSTIC_V1" as const;
export const EVALUATION_PROVIDER_BINDING_DIAGNOSTIC_VERSION = "EVALUATION_PROVIDER_BINDING_DIAGNOSTIC_V1" as const;
export const EVALUATION_PROVIDER_HISTORY_RECOVERY_VERSION = "EVALUATION_PROVIDER_HISTORY_RECOVERY_V1" as const;
export const EVALUATION_PROVIDER_AUDIO_HASH_RECOVERY_VERSION = "EVALUATION_PROVIDER_AUDIO_HASH_RECOVERY_V1" as const;
export const EVALUATION_HISTORICAL_RECOVERY_CLOSURE_VERSION = "EVALUATION_HISTORICAL_RECOVERY_CLOSURE_V1" as const;
export const CONTROLLED_FIXTURE_PLAN_VERSION = "CONTROLLED_FIXTURE_PLAN_V1" as const;

...
export function CorpusEvidenceTriage({ blocked, excluded, metadataReview, metadataAccepted, rightsPending, rightsAccepted, rightsBases, rightsKinds, reasons, facts, states, kinds }: {
  blocked: number;
  excluded: number;

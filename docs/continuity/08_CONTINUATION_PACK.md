...
For the multi-channel product surface, Documents 16–26 are authoritative. Slices 1–8 are implemented, production-active and production-FE accepted: contract, portfolio surface, append-only expert hypothesis intake, strict niche/topic isolation, Intelligence-to-Niche bridge, Evidence Intelligence & Validation, evidence-sufficient three-axis comparison, expert prioritization, separate selection/commitment and commitment-bound Channel Strategy activation. Preserve Documents 12–15 as V1 compatibility evidence; never reinterpret V1 video-topic candidates, the V1 expert-decision POST or legacy `channels.niche` as a V2 niche, priority, commitment or active strategy binding.

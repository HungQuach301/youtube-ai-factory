...
For the multi-channel product surface, Documents 16–19 are authoritative. Slices 1–3 and the Slice 3.1 identity repair are implemented: contract, portfolio surface, append-only expert hypothesis intake and strict niche/topic isolation. Continue only after checkpointing Slice 3.1, then implement Slice 4 as the permanent Evidence Intelligence & Validation capability. Preserve Documents 12–15 as V1 compatibility evidence; never reinterpret V1 video-topic candidates or the V1 expert-decision POST as a V2 niche, priority or commitment. Slices 5–8 remain permanent product capabilities for portfolio comparison, expert prioritization, commitment/governance and Channel Strategy activation.

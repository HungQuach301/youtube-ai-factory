...
PHASE_45 = IN_PROGRESS__ASSURANCE_FOUNDATION_LIVE_SCHEMA_QUALIFIED__CALIBRATION_AND_QA_COCKPIT_PENDING
...
```text
1. Calibrate exact L0-L7 judge/sampler dependencies in `AI_SHADOW`; build the QA Cockpit projection without granting PASS.

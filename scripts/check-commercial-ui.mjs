...
const checks = [
  ...
  ["Slice 4 scoring gate", files.nichePortfolioProjection.includes("BLOCKED_FOR_SLICE_5") && files.nichePortfolioProjection.includes("separately compute three-axis scoring")],

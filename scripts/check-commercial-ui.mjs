...
const checks = [
  ...
  ["Sequential production owner-first navigation", files.shell.includes('production: "/video-engine"') && files.productionV2Page.includes("Finish the current video well before starting the next")],
  ["Sequential production five-view workspace", ["Current video", "18-stage process", "Design & data", "15-video queue", "Rejected evidence"].every((label) => files.productionV2Page.includes(label))],
  ...
  ["V7 V23.4 V281 quality firewall", files.productionV2Page.includes("V7 → V23.4 → V281") && files.productionV2Page.includes("Eight independent critic roles") && files.sequentialProductionProjection.includes("P0=0 and no unresolved material P1")],
  ["Sequential production separate publishing authority", files.productionV2Page.includes("autoPublish") && files.productionV2Page.includes("YouTube auto-publish") && files.sequentialProductionProjection.includes("publishing authority is a separate gate")],

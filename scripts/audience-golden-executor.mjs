...
if ((!siteToken || !automationToken) && !previewRevision11 && !previewRevision12 && !previewRevision13 && !previewRevision14 && !previewRevision15 && !previewRevision16) throw new Error("FACTORY_SITE_AUTH_TOKEN and AUDIENCE_GOLDEN_AUTOMATION_TOKEN are required");
...
if (snapshot.nextAction === "CREATE_REPAIR_REVISION") {
  const repairRevision = snapshot.blueprint?.id?.endsWith(":r15") ? "r16" : snapshot.blueprint?.id?.endsWith(":r14") ? "r15" : snapshot.blueprint?.id?.endsWith(":r13") ? "r14" : snapshot.blueprint?.id?.endsWith(":r12") ? "r13" : snapshot.blueprint?.id?.endsWith(":r11") ? "r12" : snapshot.blueprint?.id?.endsWith(":r10") ? "r11" : snapshot.blueprint?.id?.endsWith(":r9") ? "r10" : snapshot.blueprint?.id?.endsWith(":r8") ? "r9" : snapshot.blueprint?.id?.endsWith(":r7") ? "r8" : snapshot.blueprint?.id?.endsWith(":r6") ? "r7" : snapshot.blueprint?.id?.endsWith(":r5") ? "r6" : snapshot.blueprint?.id?.endsWith(":r4") ? "r5" : snapshot.blueprint?.id?.endsWith(":r3") ? "r4" : snapshot.blueprint?.id?.endsWith(":r2") ? "r3" : "r2";
...
const revision = snapshot.blueprint.id.endsWith(":r16") ? "r16" : snapshot.blueprint.id.endsWith(":r15") ? "r15" : snapshot.blueprint.id.endsWith(":r14") ? "r14" : snapshot.blueprint.id.endsWith(":r13") ? "r13" : snapshot.blueprint.id.endsWith(":r12") ? "r12" : snapshot.blueprint.id.endsWith(":r11") ? "r11" : snapshot.blueprint.id.endsWith(":r10") ? "r10" : snapshot.blueprint.id.endsWith(":r9") ? "r9" : snapshot.blueprint.id.endsWith(":r8") ? "r8" : snapshot.blueprint.id.endsWith(":r7") ? "r7" : snapshot.blueprint.id.endsWith(":r6") ? "r6" : snapshot.blueprint.id.endsWith(":r5") ? "r5" : snapshot.blueprint.id.endsWith(":r4") ? "r4" : snapshot.blueprint.id.endsWith(":r3") ? "r3" : snapshot.blueprint.id.endsWith(":r2") ? "r2" : "r1";

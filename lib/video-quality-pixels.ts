...
export const GOLDEN_PIXEL_RENDERER_VERSION = "FOLLOW_FEE_PROGRAM_V3";
...
function sceneBody(scene: GoldenSceneKind, reveal: number, accent: string): ReactNode {
  if (scene === "OPENING_NET") return h("div", { style: { display: "flex", flexDirection: "column", gap: 18, width: "100%" } },
    ...
    h("div", { style: { display: "flex", justifyContent: "center", padding: 13, borderRadius: 12, opacity: reveal >= 3 ? 1 : .34, background: "#3a3019", color: accent, fontSize: 19, fontWeight: 800, letterSpacing: ".03em", textTransform: "uppercase" } }, "$100 gross − contractual deduction = merchant net"));
  ...
  if (scene === "COVERED_DEBIT") return h("div", { style: { display: "flex", flexDirection: "column", gap: 16, width: "100%" } }, h("div", { style: { display: "flex", alignItems: "center", width: "100%" } }, formulaStep("Base", "$0.21", true, accent, 155), h("div", { style: { display: "flex", width: 42, justifyContent: "center", color: accent, fontSize: 31, fontWeight: 850 } }, "+"), formulaStep("5 bps of $100", "$0.05", reveal >= 2, accent, 170), h("div", { style: { display: "flex", width: 42, justifyContent: "center", color: accent, fontSize: 31, fontWeight: 850 } }, "+"), formulaStep("Eligible fraud adj.", "UP TO $0.01", reveal >= 2, accent, 190), h("div", { style: { display: "flex", width: 42, justifyContent: "center", color: accent, fontSize: 31, fontWeight: 850 } }, "="), formulaStep("Issuer ceiling only", "UP TO $0.27", reveal >= 2, accent, 215)), h("div", { style: { display: "flex", justifyContent: "space-between", padding: "14px 20px", borderRadius: 12, opacity: reveal >= 3 ? 1 : .34, background: "#3a3019", color: accent, fontSize: 17, fontWeight: 850, textTransform: "uppercase" } }, h("span", null, "Not total merchant acceptance cost"), h("span", null, "Exempt debit treated differently")));

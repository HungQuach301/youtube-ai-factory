...
if ((!siteToken || !automationToken) && !previewRevision11 && !previewRevision12 && !previewRevision13 && !previewRevision14 && !previewRevision15 && !previewRevision16 && !previewRevision17 && !previewRevision18 && !previewRevision19 && !previewRevision20) throw new Error("FACTORY_SITE_AUTH_TOKEN and AUDIENCE_GOLDEN_AUTOMATION_TOKEN are required");
...
if (!snapshot.materialization) {
  ...
  const r20 = revision === "r20", r19 = revision === "r19", r18 = revision === "r18", r17 = revision === "r17", r16 = revision === "r16", r15 = revision === "r15", r14 = revision === "r14", r13 = revision === "r13", r12 = revision === "r12", r11 = revision === "r11", r10 = revision === "r10", r9 = revision === "r9", r8 = revision === "r8", r7 = revision === "r7", r6 = revision === "r6", r5 = revision === "r5", r5Plus = r5 || r6 || r7 || r8 || r9 || r10 || r11 || r12 || r13 || r14 || r15 || r16 || r17 || r18 || r19 || r20;

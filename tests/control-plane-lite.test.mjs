...
test("V21.3 preparing intent resumes automatically and reports transport truthfully", () => {
  ...
  assert.match(page, /Resuming approved V21\.3 intent/);
  assert.match(page, /AUTHOR_WAVE_BATCH_2_V21_3_SEMANTIC_PLANS/);
  assert.match(page, /Factory-issued token IDs/);
});
